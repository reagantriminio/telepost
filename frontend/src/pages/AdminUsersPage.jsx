      ...
      <header className="bg-gray-800 border-b border-gray-700 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link to="/admin/logs" className="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-md transition-colors">Logs</Link>
            <Link to="/admin/users" className="px-4 py-2 bg-blue-600 rounded-md">Users</Link>
            ...
            <button
              ...
              className="px-4 py-2 bg-green-600 hover:bg-green-700 rounded-md">Add User</button>
          </nav>
        </div>
      </header>
